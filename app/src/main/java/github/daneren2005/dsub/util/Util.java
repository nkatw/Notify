...
public final class Util {
	...
	/*
	 * Util for hide status bar and navigation bar.
	 * @param Window, from getWindow() on Activity or Dialog
	 * For Activity, call it on onWindowFocusChanged()
	 * For DialogFragment, call it on onViewCreated()
	 */
	public static void toImmersiveMode(Window window) {
		if (window != null) {
